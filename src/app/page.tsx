      ...
      <div style={{ maxWidth: '480px', margin: '0 auto', padding: '10px' }}>
        ...
        {!loading && filtered.length > 0 && (
          <div>
            ...
            {pickupKeys.length > 0 && (
              <div>
                <div style={{ fontSize: '11px', fontWeight: 900, color: '#555', padding: '4px 6px', marginBottom: '6px', display: 'flex', alignItems: 'center', gap: '5px' }}>
                  <span style={{ width: 7, height: 7, borderRadius: '50%', backgroundColor: '#27ae60', flexShrink: 0 }}></span>
